...
import ico from '../../assets/image/ico.png'
import 'animate.css';
...
const Nav = () => {
    ...
    const links = (
        <>
            <li>
                <NavLink
                    className={({ isActive }) =>
                        isActive ? 'btn btn-outline btn-info' : 'font-bold'
                    }
                    to='/'
                >
                    Home
    ...
    return (
        <div className="navbar w-full mt-5 bg-blue-950 font-bold">
            <div className="navbar-start skeleton bg-blue-950">
