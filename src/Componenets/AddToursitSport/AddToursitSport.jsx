...
const AddToursitSport = () => {
    const{user} = useContext(AuthContext);
         const handelAddSpot = event =>{
            ...
            const newTourst ={name,TouristSpotName,countryName,shortDescription,averageCost,Location,seasonality,TotaVisitorsPerYear,email,Image,travelTime,newTourst}
         }
    return (
        <div className="baka">
            <div className="p-5">
                ...
                <form onSubmit={handelAddSpot}>
                    <div className="grid md:grid-cols-2 gap-5 mt-5">
                        ...
                        <div>
                            ...
                            <input className="w-full border-2 px-4 py-2" type="text" placeholder="TotaVisitorsPerYear" name="stockStatus" id="" />
                        </div>
                        <div>
